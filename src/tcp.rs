...
fn tcp_parse(input: &[u8]) -> IResult<&[u8], TcpHeader> {
    ...
    Ok((
        ...
        TcpHeader {
            ...
            flag_cwr: dataof_res_flags.2 & 0b1000_0000 == 0b1000_0000,
            flag_ece: dataof_res_flags.2 & 0b0100_0000 == 0b0100_0000,
            flag_urg: dataof_res_flags.2 & 0b0010_0000 == 0b0010_0000,
            flag_ack: dataof_res_flags.2 & 0b0001_0000 == 0b0001_0000,
            flag_psh: dataof_res_flags.2 & 0b0000_1000 == 0b0000_1000,
            flag_rst: dataof_res_flags.2 & 0b0000_0100 == 0b0000_0100,
            flag_syn: dataof_res_flags.2 & 0b0000_0010 == 0b0000_0010,
            flag_fin: dataof_res_flags.2 & 0b0000_0001 == 0b0000_0001,
            window,
            checksum,
            urgent_pointer,
            options: None,
